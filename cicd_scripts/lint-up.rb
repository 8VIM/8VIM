...
#   }
LINT_REPORT_FILE = String.new("8vim/lint-report.html")
...
issues_string = output[/[0-9]+ issues found/]

# find number of errors
current_issue_count = issues_string.match(/[0-9]*/)[0].to_i
puts "found issues: " + current_issue_count.to_s
...
if previous_lint_reports == nil ||
    ...
    File.open previous_lint_report do |file|
      previous_error_warning_string = file.find { |line| line =~ /[0-9]+ issues found/ }
    end
...
if previous_results == true  &&
    ...
    puts "FAIL: issue count increased"
    exit 1
end
