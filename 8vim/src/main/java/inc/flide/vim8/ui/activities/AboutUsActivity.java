...
public class AboutUsActivity extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupLink(R.id.constraintLayout_github, getString(R.string.vim8__repository_url));
    ...
    private void setupLink(int constraintLayoutId, String uriString) {
        ...
        constraintLayout.setOnTouchListener((v, event) -> {
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN -> constraintLayout.setBackgroundColor(Color.LTGRAY);
