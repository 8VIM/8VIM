...
public final class MovementSequenceHelper {
    ...
    public static List<FingerPosition> computeMovementSequence(int layer, Pair<SectorPart, SectorPart> sectorParts,
        ...
        List<FingerPosition> movementSequenceForExtraLayer =
                movementSequenceForExtraLayer(layer, sectorParts, position);
        movementSequence.addAll(movementSequenceForExtraLayer);
        movementSequence.add(FingerPosition.INSIDE_CIRCLE);
        return movementSequence;
    }

    private static List<FingerPosition> movementSequencesForDefaultLayer(Pair<SectorPart, SectorPart> sectorParts,
                                                                         CharacterPosition position) {
        List<FingerPosition> movementSequence = new ArrayList<>();
    ...
    private static List<FingerPosition> movementSequenceForExtraLayer(int layer,
                                                                      Pair<SectorPart, SectorPart> sectorParts,
                                                                      CharacterPosition position) {
    ...
    private static FingerPosition getNextPosition(Pair<SectorPart, SectorPart> sectorParts,
                                                  FingerPosition lastPosition) {
